<div class="timeline-event timeline-labeled">
  ...
  <div class="timeline-content">
    <div class="timeline-header">
      ...
      @endif
      <span class="timeline-action">added label</span>
      @if(isset($data['label']))
        <span class="timeline-label" style="background-color: #{{ $data['label']['color'] }}; color: {{ $data['label']['color'] === 'ffffff' || $data['label']['color'] === 'FFFFFF' ? '#000' : '#fff' }}">
          {{ $data['label']['name'] }}
        </span>
      @endif
