<script>
  // This file shows the MINIMAL changes needed to add syntax highlighting to FileTab.svelte
  // Compare with the original FileTab.svelte
  ...
  // Pre-detect language for each file to avoid repeated detection
                  ...
                  <div class="side left-side">
                    ...
                    <div class="diff-line-content diff-line-{changedLinePair.left.type}">
                      {#if changedLinePair.left.type !== 'empty'}
                        ...
                        <!-- ===== REPLACE THIS LINE ===== -->
                        <!-- OLD: <code class="code">{changedLinePair.left.content}</code> -->
                        <!-- NEW: -->
                        <HighlightedDiffLine
                  ...
                  <div class="side right-side">
                    ...
                    <div class="diff-line-content diff-line-{changedLinePair.right.type}">
                      {#if changedLinePair.right.type !== 'empty'}
                        ...
                        <!-- ===== REPLACE THIS LINE ===== -->
                        <!-- OLD: <code class="code">{changedLinePair.right.content}</code> -->
                        <!-- NEW: -->
                        <HighlightedDiffLine
